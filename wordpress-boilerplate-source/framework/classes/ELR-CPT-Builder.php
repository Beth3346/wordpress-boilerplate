...
class ELR_CPT_Builder {
    ...
    public function get_default_settings( $singular_name, $plural_name ) {
    ...
    public function taxonomy_add_default_terms( $parent, $terms ) {
    ...
    public function register_post_types( $singular_name, $plural_name, $supports, $taxonomies, $hierarchical = false, $archive = true ) {
        $text_domain = 'elr-' . str_replace( '_' , '-', $singular_name );

        /* Get the plugin settings. */
        $settings = get_option( 'plugin_elr_' . $plural_name, $this->get_default_settings( $singular_name, $plural_name ) );
    ...
    public function register_taxonomies( $singular_name, $plural_name, $cpt_singular, $cpt_plural, $hierarchical = true, $default_terms ) {
        $text_domain = 'elr-' . str_replace( '_' , '-', $singular_name );

        /* Get the plugin settings. */
        $settings = get_option( 'plugin_elr_' . $cpt_plural, $this->get_default_settings( $cpt_singular, $cpt_plural ) );
        ...
        // add default terms
        $this->taxonomy_add_default_terms( $singular_name, $default_terms );
    }
}